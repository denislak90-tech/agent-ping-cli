...
Read this before wiring an agent to this project. Two equivalent implementations exist — pick whichever fits the host OS. Both read/write the same state format, so you can mix them (e.g. ask from one, watch from the other).
